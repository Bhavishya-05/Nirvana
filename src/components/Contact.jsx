...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "53d8f86e-f109-43ae-8c6c-63c0bef1f53c");
  ...
  return (
    ...
    className='text-center p-6 y-20 lg:px-32 w-full
    ...
    <form onSubmit={onSubmit} className='max-w-2xl mx-auto text-gray-600 pt-8'>
        <div className='flex flex-wrap'>
            ...
            px-4 mt-2 h-12' type="text" name='Name' placeholder='Your Name' required/>
            </div>
            <div className='w-full md:w-1/2 text-left md:pl-4'>
            Your Email
            <input className='w-full border border-gray-300 rounded
            px-4 mt-2 h-12' type="email" name='Email' placeholder='Your Email' required/>
            </div>
